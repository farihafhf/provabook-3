                ...
                <table className="w-full">
                  <thead className="sticky top-0 z-20 bg-slate-100 shadow-sm">
                    <tr className="text-left text-xs uppercase tracking-wide text-slate-700 border-b-2 border-slate-300">
                      ...
                      <th className="py-3 px-3 font-semibold whitespace-nowrap min-w-[100px]">PO #</th>
                      ...
                      <th className="py-3 px-3 font-semibold whitespace-nowrap min-w-[130px]">Production Stage</th>
                      ...
                      <th className="py-3 px-3 font-semibold whitespace-nowrap min-w-[120px] border-l border-slate-200">Merchandiser</th>
